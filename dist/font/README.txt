...
- Usually, it's enough to publish
 content of LICENSE.txt file somewhere on your
...
- /font/* - fonts in different
 formats

- /css/*  - different kinds of css, for all situations. Should be ok with 
  twitter bootstrap. Also, you can skip <i> style and assign icon classes
  directly to text elements
, if you don't mind about IE7.
...
- config.json - keeps
 your settings. You can import it back to fontello anytime,
...
- basic file,
 <your_font_name>.css - is usually enougth, in contains @font-face
...
- *-codes.css and *-ie7-codes.css - if you like to use your own @font-face
  ...
  convenient
 for automated assets build systems. When you need to update font -
  no needs to manually edit files, just override old version with archive
  content. See fontello source
 codes for example.
